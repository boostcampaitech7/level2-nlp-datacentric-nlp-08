...
EXAONE_FEW_SHOT_TEMP = '''[|system|] You are EXAONE model from LG AI Research, a helpful assistant. [|endofturn|]
[|user|] 다음 헤드라인에서 특수문자, 숫자, 영어로 대체된 부분을 올바른 단어로 복원해. 

### 다음 지침을 따라야해.
- 제시된 주제 번호에 해당하는 예시들의 내용을 통해 주제를 파악하세요.
- 텍스트에서 의미 있는 단어나 구문을 식별하세요.
- 식별된 키워드와 주제에 맞는 헤드라인으로 복원하세요.
- 키워드를 식별할 수 없다면 주제에 맞는 새롭고 창의적인 헤드라인을 만드세요.
- 복원할게 없으면 원본 그대로 헤드라인을 만드세요.
- 설명은 출력하지 마세요.
Step	Training Loss	Validation Loss	F1
100	1.044900	0.676715	0.805952
200	0.714300	0.623629	0.798980
300	0.594700	0.620310	0.820718
400	0.525300	0.509129	0.845158
500	0.552800	0.456466	0.854441
600	0.341000	0.427720	0.866880
700	0.259200	0.422794	0.872947
800	0.305100	0.414816	0.886920
900	0.228400	0.405666	0.887198
1000	0.251800	0.397939	0.888486
### 주제 번호 0 예시:
...
def main():
    ...
    df.to_csv("./resources/processed/train_noisy_restore.csv",encoding='utf-8-sig')
